...
def test_halostatistics():
    ...
    HS_tinker = HaloStatistics(
        perturbations, TinkerHaloStatisticsModel, overdensity_type="vir"
    )
    HS_castro = HaloStatistics(
        perturbations, CastroHaloStatisticsModel, overdensity_type="vir"
    )
