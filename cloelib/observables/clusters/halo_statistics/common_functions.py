...
class prop:
    ...
    def set_use_interpolation(self, use_interpolation):
    ...
    def set_halo_statistics_model(self, value):
...
def radius_M(self, M):
    ...
    """
    rho_m_0 = (
        dc.rho_crit(self.background, 0.0) * self._Omega_m(0.0) / self.background.h**2.0
    )
